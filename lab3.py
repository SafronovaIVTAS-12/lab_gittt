...
directory_path = "C:/Users/marga/PycharmProjects/pythonProject12"  # Путь к директории, которую нужно обработать
...
csv_filename = "office.csv"  # Имя файла с данными
...
filtered_data = filter_by_criteria(data, "room_number", 102)
print("Данные, соответствующие перемещениям в комнату 102:")
print_dict(filtered_data)

# Добавление новых данных и запись их в CSV-файл
with open(csv_filename, 'a', newline='') as csvfile:
    add_movement_to_dict(csvfile, data, 4, "2023-05-01 14:00:00", False, 105)
    add_movement_to_dict(csvfile, data, 5, "2023-05-31 12:00:00", True, 102)